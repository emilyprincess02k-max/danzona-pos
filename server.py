...
def init_db():
    try:
        ...
        conn.execute('CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, username TEXT NOT NULL, password TEXT NOT NULL, name TEXT, role TEXT DEFAULT "staff", store TEXT DEFAULT "main", created_at TEXT DEFAULT CURRENT_TIMESTAMP, UNIQUE(pharmacy_id, username))')
        conn.execute('CREATE TABLE IF NOT EXISTS categories (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, name TEXT NOT NULL, UNIQUE(pharmacy_id, name))')
        conn.execute('CREATE TABLE IF NOT EXISTS products (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, name TEXT NOT NULL, sku TEXT NOT NULL, category_id INTEGER, category_name TEXT DEFAULT "Uncategorized", description TEXT, price REAL DEFAULT 0, cost_price REAL DEFAULT 0, stock REAL DEFAULT 0, reorder_level REAL DEFAULT 10, expiry TEXT, prices TEXT, default_pkg_sale TEXT DEFAULT "pkt", default_pkg_receive TEXT DEFAULT "pkt", created_at TEXT DEFAULT CURRENT_TIMESTAMP, UNIQUE(pharmacy_id, sku))')
        conn.execute('CREATE TABLE IF NOT EXISTS sales (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, date TEXT DEFAULT CURRENT_TIMESTAMP, customer_id INTEGER, customer_name TEXT, items TEXT, subtotal REAL DEFAULT 0, discount_amount REAL DEFAULT 0, tax REAL DEFAULT 0, total REAL DEFAULT 0, payment_method TEXT DEFAULT "cash", amount_tendered REAL DEFAULT 0, change REAL DEFAULT 0, cashier TEXT, notes TEXT)')
        conn.execute('CREATE TABLE IF NOT EXISTS customers (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, cust_id TEXT, first_name TEXT, last_name TEXT, email TEXT, phone TEXT, address TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP)')
        conn.execute('CREATE TABLE IF NOT EXISTS employees (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, emp_id TEXT, first_name TEXT NOT NULL, last_name TEXT NOT NULL, email TEXT, phone TEXT, position TEXT, department TEXT, status TEXT DEFAULT "active", salary REAL DEFAULT 0, hire_date TEXT, employment_type TEXT DEFAULT "full-time", created_at TEXT DEFAULT CURRENT_TIMESTAMP)')
        conn.execute('CREATE TABLE IF NOT EXISTS inventory (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, product_id INTEGER, quantity REAL DEFAULT 0, location TEXT, batch_number TEXT, expiry_date TEXT, cost_price REAL, selling_price REAL, last_restocked TEXT, reorder_level REAL DEFAULT 10)')
        conn.execute('CREATE TABLE IF NOT EXISTS expenses (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, date TEXT DEFAULT CURRENT_TIMESTAMP, category TEXT, description TEXT, amount REAL DEFAULT 0, receipt_number TEXT, created_by TEXT)')
        conn.execute('CREATE TABLE IF NOT EXISTS payments (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, paymentId TEXT, date TEXT DEFAULT CURRENT_TIMESTAMP, customer INTEGER, supplier INTEGER, invoice TEXT, amount REAL DEFAULT 0, method TEXT, status TEXT DEFAULT "paid", notes TEXT, created_by TEXT)')
        conn.execute('CREATE TABLE IF NOT EXISTS locations (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, name TEXT NOT NULL, address TEXT, phone TEXT, manager TEXT, status TEXT DEFAULT "active")')
        conn.execute('CREATE TABLE IF NOT EXISTS appointments (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, customer_name TEXT, customer_phone TEXT, date TEXT, time TEXT, service TEXT, status TEXT DEFAULT "pending", notes TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP)')
        conn.execute('CREATE TABLE IF NOT EXISTS giftcards (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, code TEXT UNIQUE NOT NULL, amount REAL DEFAULT 0, balance REAL DEFAULT 0, customer_name TEXT, customer_phone TEXT, expiry_date TEXT, status TEXT DEFAULT "active", issued_at TEXT DEFAULT CURRENT_TIMESTAMP)')
        conn.execute('CREATE TABLE IF NOT EXISTS messages (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, from_user TEXT, to_user TEXT, subject TEXT, body TEXT, status TEXT DEFAULT "unread", created_at TEXT DEFAULT CURRENT_TIMESTAMP)')
        conn.execute('CREATE TABLE IF NOT EXISTS deliveries (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, sale_id INTEGER, customer_name TEXT, address TEXT, phone TEXT, status TEXT DEFAULT "pending", delivery_date TEXT, driver TEXT, notes TEXT)')
        conn.execute('CREATE TABLE IF NOT EXISTS invoices (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, invoice_number TEXT UNIQUE NOT NULL, customer_name TEXT, customer_phone TEXT, customer_email TEXT, items TEXT, subtotal REAL DEFAULT 0, tax REAL DEFAULT 0, total REAL DEFAULT 0, status TEXT DEFAULT "unpaid", due_date TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP)')
        conn.execute('CREATE TABLE IF NOT EXISTS suppliers (id INTEGER PRIMARY KEY AUTOINCREMENT, pharmacy_id INTEGER NOT NULL, name TEXT NOT NULL, contact_person TEXT, phone TEXT, email TEXT, address TEXT, status TEXT DEFAULT "active", created_at TEXT DEFAULT CURRENT_TIMESTAMP)')
        conn.commit()
        conn.close()
    except Exception as e:
        pass  # Ignore init errors for now

init_db()  # Initialize DB on module load
